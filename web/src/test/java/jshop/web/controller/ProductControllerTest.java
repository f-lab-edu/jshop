...
@WebMvcTest(controllers = {ProductController.class, GlobalExceptionHandler.class}, excludeAutoConfiguration =
...
class ProductControllerTest {
    ...
    class GetOwnProducts {
        ...
        public void getOwnProducts() throws Exception {
            ...
            ResultActions perform = mockMvc.perform(
                MockMvcRequestBuilders.get("/api/products?page=0&size=10").with(
        ...
        public void getOwnProducts_defaultValue() throws Exception {
            // when
            ResultActions perform = mockMvc.perform(
                MockMvcRequestBuilders.get("/api/products").with(MockSecurityContextUtil.mockUserSecurityContext()));
    ...
    class UpdateProductDetail {
        ...
        public void updateProductDetail_noBody() throws Exception {
            // when
            ResultActions perform = mockMvc.perform(
                MockMvcRequestBuilders.put("/api/products/1/details/1").with(
                    MockSecurityContextUtil.mockUserSecurityContext()));
            // then
    ...
    class UpdateProductDetailStock {
        ...
        public void updateProductDetailStock_noBody() throws Exception {
            ...
            // when
            ResultActions perform = mockMvc.perform(
                MockMvcRequestBuilders.patch("/api/products/1/details/1/stocks").with(
                    MockSecurityContextUtil.mockUserSecurityContext()));
    ...
    class DeleteProductDetail {
        ...
        public void deleteProductDetail_success() throws Exception {
            // when
            mockMvc.perform(MockMvcRequestBuilders.delete("/api/products/1/details/1").with(
                MockSecurityContextUtil.mockUserSecurityContext()));
            // then
